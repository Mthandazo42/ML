...
"""
THE EPOCHS HAS BEEN REDUCED FROM 20 TO 4 TO ELIMINATE OVERFITTING WHICH WAS PRESENT EARLIER
TRY TO PLACING BACK 20 EPOCHS AND SEE IF YOU CAN OBSERVE FROM THE PLOTTED GRAPHS THE POINTS
WHERE OVERFITTING STARTS TO SKY ROCKET

OUR NETWORK RETURNS A HISTORY OBJECT WHICH IS A DICTIONARY FILE CONTAINING
